...
3. **For the most polished open-source feature set**, [TypeWhisper](https://github.com/TypeWhisper/typewhisper-mac) has global push-to-talk, live streaming preview, and per-app workflows: terminal handling and cursor insertion are included. It can use local WhisperKit, Parakeet, and other local engines.
