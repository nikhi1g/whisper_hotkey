...
info "  3. Launch it. Gatekeeper should verify the notarized app without"
info "     Move to Trash or an Open Anyway approval"
info "  4. Expect: first-run setup, then Microphone, Accessibility, and"
info "     Input Monitoring prompts. The bundled default model should be ready"
printf '\n'
